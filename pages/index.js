...
class MyDapp extends Component{
  state = {
    ...
    web3Settings:{
      ...
      chains: [
        {name:"Ethereum", id:1, options:{trips:{address:"0x1350Fbe8Ce27762ec19134bf8FC405a427fe9Bf1",amount:"1000000000000000000"},loot:"y",coin:""}},
        {name:"Polygon", id:137, options:{trips:{address:"0x1350Fbe8Ce27762ec19134bf8FC405a427fe9Bf1",amount:"1000000000000000000"},loot:"",coin:"MATIC"}},
        {name:"Rinkeby", id:4, options:{trips:{address:"0x8978fa89c4d20305f7d885d71a776174b13a28b5",amount:"1000000000000000000"},loot:"0xaeA3ad95Dc000F603622Ef2FFD915bC3D26573a7",coin:"ETH"}},
      ]
    }
  };
